...
- Use one consistent role label for the same participant, and make every pronoun and arrival reference resolve to exactly one established person. When two or more people are present, do not use singular they or their for a mission-relevant action, object, or event; repeat the person's name or role.

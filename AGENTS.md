...
- When adding or releasing another learning language, use `.agents/skills/add-language/SKILL.md` and follow its explicit authenticated Supabase catalog-registration rollout.
